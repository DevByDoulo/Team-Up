...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // Création de l'entité demande mise à jour
        $demande->demande_objet = $objet;
        $demande->demande_texte = $texte;
        $demande->demande_date_creation = $date_creation;
        $demande->demande_date_echeance = $date_echeance;
        $demande->id_type_demande = $id_type;
        $demande->id_utilisateur = $id_utilisateur;
        
        // Modification via le service
        if ($demandeService->editdemande($demande)) {
            ...
            $errors[] = 'Erreur lors de la modification de la demande';
        }
    }
...
<head>
    ...
    <title>Team Up - Modifier une demande</title>
    <!-- Bootstrap 4 via CDN -->
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="text-center mb-4"><i class="fas fa-edit"></i> Modifier la demande</h2>
            
            <div class="info-badge">
                <i class="fas fa-info-circle"></i> Demande #<?php echo $demande->id_demande; ?>
            </div>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="demande_objet" name="demande_objet" 
                           ...
                           value="<?php echo isset($_POST['demande_objet']) ? htmlspecialchars($_POST['demande_objet']) : htmlspecialchars($demande->demande_objet); ?>">
                </div>

                <div class="form-group">
                    <label for="demande_texte">Description</label>
                    <textarea class="form-control" id="demande_texte" name="demande_texte" 
                              rows="4" placeholder="Détaillez votre demande..."><?php echo isset($_POST['demande_texte']) ? htmlspecialchars($_POST['demande_texte']) : htmlspecialchars($demande->demande_texte); ?></textarea>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="demande_date_creation" name="demande_date_creation" 
                                   value="<?php echo isset($_POST['demande_date_creation']) ? htmlspecialchars($_POST['demande_date_creation']) : htmlspecialchars($demande->demande_date_creation); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="demande_date_echeance" name="demande_date_echeance" 
                                   value="<?php echo isset($_POST['demande_date_echeance']) ? htmlspecialchars($_POST['demande_date_echeance']) : htmlspecialchars($demande->demande_date_echeance); ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_type_demande" name="id_type_demande" required>
                                ...
                                <?php 
                                $selectedType = isset($_POST['id_type_demande']) ? $_POST['id_type_demande'] : $demande->id_type_demande;
                                foreach ($types as $type): ?>
                                    <option value="<?php echo $type->id_type_demande; ?>"
                                        <?php echo ($selectedType == $type->id_type_demande) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_utilisateur" name="id_utilisateur">
                                ...
                                <?php 
                                $selectedUser = isset($_POST['id_utilisateur']) ? $_POST['id_utilisateur'] : $demande->id_utilisateur;
                                foreach ($utilisateurs as $user): ?>
                                    <option value="<?php echo $user->id_utilisateur; ?>"
                                        <?php echo ($selectedUser == $user->id_utilisateur) ? 'selected' : ''; ?>>
